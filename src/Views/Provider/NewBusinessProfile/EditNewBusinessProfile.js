...
const EditNewBusinessProfile = () => {
  ...
  useEffect(() => {
    if (refid) {
      ...
      AlertModal02.show("Invalid business information.", "Oops!", () => {
    ...
    try {
      HTTP.put(
        ...
        if (res && res.status && res.status === 200) {
          ...
          AlertModal02.show(
            <div className="p-2">Business information updated successfully.</div>,
            "Success!"
          );
        }
      });
        ...
        <Row>
          <Col lg={12} md={12} xl={12}>
            <GAlign align="between" className="mb-2">
              <h3 className="fs24 colorBlack fBold">Edit Basic Info</h3>
...
export default EditNewBusinessProfile;

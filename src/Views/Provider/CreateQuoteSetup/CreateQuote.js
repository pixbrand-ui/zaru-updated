...
const CreateQuote = (props) => {
  ...
  const getFullName = () => {
    if (history.location.state && history.location.state.userData) {
      return (
        history.location.state.userData.firstname +
        " " +
        history.location.state.userData.lastname
      );
    } else {
      if (quoteInfo) {
        return quoteInfo.userData.firstname + " " + quoteInfo.userData.lastname;
      } else {
        return "";
      }
    }
  ...
  const [quoteData, setquoteData] = useState({
    businessid: history.location.state
      ...
      : quoteInfo
      ? quoteInfo.businessid
      : null,
    taskid: history.location.state
    ...
    name: getFullName(),
    quoteDate: Date.now(),
    ContactNumber: history.location.state
      ? history.location.state.userData.phone
      : quoteInfo
      ? quoteInfo.userData.phone
      : "",
    validTo: Date.now(),
    email: history.location.state
      ? history.location.state.userData.email
      : quoteInfo
      ? quoteInfo.userData.email
      : "",
    address: "",
    quotesItems: [],
    notes: "",
  ...
  return (
    <>
      ...
      {goToNextPage && (
        <QuoteReview data={quoteData} callback={setGoToNextPage} />
      )}
    </>
  );
};

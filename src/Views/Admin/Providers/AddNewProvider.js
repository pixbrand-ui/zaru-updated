...
import GImageUpload2 from "../../../Components/Provider/GImageUpload2/GImageUpload2";
import GImageUpload from "../../../Components/Provider/GImageUpload/GImageUpload";

const AddNewProvider = (props) => {
  ...
  const saveData = () => {
    ...
    iData.append("bussinessname", data.bussinessname);
   ...
   if(data.password.trim()==="" || data.password.trim()===null){
    ...
    try {
      HTTP.post(API.createProvider, iData, true, false, Auth.getToken()).then(
        (res) => {
  ...
  return (
    <div className="pt10">
      ...
      <Row>
        ...
        <Col lg={4}>
          <div className="mb10">
            <label className="fs16 mb7 mr7" htmlFor="email">
              DOB
            </label>
            {
              data.dob
            ...
            <DatePicker
              ...
              selected=""
              onChange={(dobe) => setData({ ...data, dob: dateConverter(dobe) })}
        ...
        <Col lg={4}>
          <div className="mb10">
            ...
            <GImageUpload2 getImage2={getlogoUrl} />
          </div>
        </Col>

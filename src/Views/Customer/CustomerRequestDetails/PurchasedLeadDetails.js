...
const PurchasedLeadDetails = () => {
  return (
    <div>
      <section className="bgLightOrange pt60 pb60">
        <Container>
          <Row>
            <section className="bgWhite pt30 pb30 pl35 pr35 radius">
              <div>
                <h1 className="fs24 fBold">Request for House Cleaning</h1>
                <Row>
                  <Col lg={9}>
                    <div className="d-flex mb15 align-items-end justify-content-between">
                      <div className="d-flex align-items-center">
                        ...
                        <div>
                          ...
                          <p className="fs16 mb0 colorOrange">Robin R</p>
                        </div>
                      </div>
                    ...
                    <div className="mb20">
                      ...
                      <div className="d-flex mb7">
                        <span className="mr10">{Svg.watch}</span>
                        <p className="fs16 colorBlack mb0">
                          Service Required by: I am Flexible
                        </p>
                      </div>
                      <div className="d-flex mb7">
                        <span className="mr10">{Svg.people}</span>
                      ...
                      <div className="d-flex justify-content-between mb7">
                        ...
                        <span className="fs16 radius colorGreen pl15 pr15 bgGreenOpacity">
                          Verified
                        </span>
                      </div>
                      <div className="d-flex justify-content-between mb7">

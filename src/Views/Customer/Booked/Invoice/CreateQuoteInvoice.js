...
const CreateQuoteInvoice = (props) => {
  // const data={
              ...
              <section className="bgWhite border">
                ...
                <div className="pl30 pr30">
                  ...
                  <div className="d-flex justify-content-between ">
                    ...
                    <div>
                      <span className="fs16 colorPara">Quotation Date:</span>
                ...
                <div className="d-flex  justify-content-around">
                  ...
                  >
                    <p className="fs16 colorGreen pt15 w-100">
                      <span className="mr10 d-block">{Svg.accept}</span>Accept Quote
                    </p>
                  </Link>
...
export default CreateQuoteInvoice;
